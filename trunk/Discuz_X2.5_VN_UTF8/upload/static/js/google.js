...
document.writeln('<form name="gform" id="gform" method="get" autocomplete="off" action="http://www.google.com.vn/search?" target="_blank" onSubmit="validate_google(this);">');
...
document.writeln('<option value="0"' + google_default_0 + '>Tìm kiếm Web</option>');
document.writeln('<option value="1"' + google_default_1 + '>Tìm trong trang</option>');
