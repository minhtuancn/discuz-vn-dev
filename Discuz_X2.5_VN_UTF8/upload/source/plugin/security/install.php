...
// ALTER TABLE  `pre_security_failedlog` ADD  `scheduletime` INT( 10 ) NOT NULL DEFAULT  '0' COMMENT  '计划重试时间'
// ALTER TABLE  `pre_security_failedlog` ADD  `lastfailtime` INT( 10 ) NOT NULL DEFAULT  '0' COMMENT  '上次失败时间'
runquery($sql);
